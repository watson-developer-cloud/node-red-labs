...
To understand the contents of the output go to ->  [Watson tradeoff](https://console.bluemix.net/docs/services/tradeoff-analytics/output.html) and [Explanation of tradeoff JSON](https://developer.ibm.com/answers/questions/191441/need_explanation_of_solutionperspective_response_f.html)
